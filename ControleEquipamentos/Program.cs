...
namespace ControleEquipamentos
{
    internal class Program
    {
        ...
        static void Main()
        {
            ...
            numerosDeSerie.Add(999);
            precos.Add(20000);
            fabricantes.Add("Motorola");
            datasDeFabricacao.Add("10/04/2000");

            nomes.Add("Telefone");
            idsEquipamentos.Add(1);
            numerosDeSerie.Add(99999);
            precos.Add(20000);
            fabricantes.Add("Sansung");
            datasDeFabricacao.Add("12/05/2020");
        ...
        static void ExcluirEquipamento(ArrayList nomes, ArrayList precos, ArrayList idsEquipamentos, ArrayList numerosDeSerie, ArrayList fabricantes, ArrayList datasDeFabricacao)
        {
